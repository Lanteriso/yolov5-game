...
img_train_path ='images/train2012/'  #图片训练集保存路径，需要自己新建
img_val_path = 'images/val2012/'     #图片验证集保存路径   需要自己新建
labels_train_path = 'labels/train2012/'       #标签训练集保存路径   需要自己新建
labels_val_path = 'labels/val2012/'           #标签验证集保存路径   需要自己新建

dir_images = 'JPEGImages/'                       #数据集路径
dir_labels  = 'YoloLabels/'                  #标签路径
